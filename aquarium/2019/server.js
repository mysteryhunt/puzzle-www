...
const SPECIAL_MESSAGES = {
  2: {
    TEMPERATUREMEASURER:
      "You’re almost there! What’s a word for a TEMPERATURE MEASURER?",
  },
};
...
const STOCK_MESSAGES = {
  ...
  correct:
    "Your answer of {answer} is Correct!{storyline}",
  incorrect:
  ...
  final_puzzle:
    "Your answer of {answer} is Correct!{storyline} You have solved all {num_puzzles} puzzles! Come to the front desk to receive the meta puzzle! To submit the meta, text 'meta' and then the answer",
  meta_correct:
    "Congratulations, {answer} was correct! Go see Mission Control at the front desk!",
