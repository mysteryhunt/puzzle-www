...
const ANSWERS = {
  ...
  7: "BANKRUPT",
  8: "POUND",
  META: "UNBURSTHISBUBBLE",
};

const STORYLINE = {};

const SPECIAL_MESSAGES = {
  2: { BAT: "Close! Call in the text exactly as it appears." },
  4: { THISTHAT: "Close! Apply the puzzle mechanic again." },
  6: { CARTONS: "Close! Call in the text exactly as it appears." },
};
